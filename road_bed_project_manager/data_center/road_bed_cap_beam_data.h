...
public:
	//common
	demo_cap_beam_common		m_Common;		//基本属性
	
	//advance
	demo_cap_beam_general		m_Gen;			//总体属性
	demo_cap_beam				m_GL;			//盖梁属性
	demo_cap_beam_Pier			m_Pier;			//桩基属性
	demo_cap_beam_foundation	m_JC;			//基础属性
	demo_cap_beam_drawsetting	m_DrawSet;		//绘图设置
	demo_cap_beam_parameters	m_CSHLB;		//参数化列表
	demo_cap_beam_material		m_Materials;	//材料统计
};
